...
Description: This program creates two methods of implementing the quick sort algorithm.
Both generic, one using a comparator and another using the compareTo method.
The program tests the methods by creating two arrays, sorting them, and printing out their contents.
*/
...
public class Exercise23_03 {
  ...
  // Comparable QuickSort method
  public static <E extends Comparable<E>> void quickSort(E[] list) {
    quickSort(list, 0, list.length - 1);
  }

  // Comparable Helper Method
