...
class TwoWayLinkedList<E> extends java.util.AbstractSequentialList<E> {
	...
	public void addFirst(E e) {
		...
		if (head != tail && previousHead != null) {
			newNode.next = previousHead; // link the new node with the head
	...
	public void addLast(E e) {
		...
		size++; // Increase size
		// TODO For a two-way linked list, link the tail's previous element to temp
