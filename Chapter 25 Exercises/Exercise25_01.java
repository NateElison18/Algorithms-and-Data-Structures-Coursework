 ...
 * Date: 7/19/23
 * 
 * This program adds the height and breadthFirst methods to the binary search tree example provided by the book. 
 * It tests the two methods by creating trees and calling the methods. 
 *
 */
  ...
  public class BinaryTree<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public void breadthFirstTraversal() {
      ...
      while (queue.isEmpty() == false) {
    	  ...
    	  System.out.println(tempNode.element.toString());
